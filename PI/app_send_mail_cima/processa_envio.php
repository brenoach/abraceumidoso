...
class Mensagem {
	...
	try {
			...
			$mail->Username   = 'coloque o seu e-mail de envio aqui';                     //SMTP username
			$mail->Password   = 'etlz ohki jzpf hjnp Crie uma senha igual a essa, passo a passo'; //SMTP password
