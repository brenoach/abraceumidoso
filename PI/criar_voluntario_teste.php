...
try {
    ...
    $pdo->exec("INSERT INTO endereco (cep, estado, cidade, bairro, nmLogradouro, numero) 
    ...
    $stmtContato = $pdo->prepare("INSERT INTO contatos (email) VALUES (?)");
    ...
    $stmtPessoa = $pdo->prepare("INSERT INTO pessoa (nmPessoa, cpf, dtNascimento) VALUES (?, ?, ?)");
    ...
    $stmtVoluntario = $pdo->prepare("INSERT INTO voluntario (senha, pessoa_idPessoa, endereco_idEndereco, contatos_idcontatos) VALUES (?, ?, ?, ?)");
