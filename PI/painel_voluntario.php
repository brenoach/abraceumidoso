...
<head>
    ...
    <style>
        ...
        .tag-instituicao {
            display: inline-block; background: #eef5ee; color: #2e7d32;
            padding: 5px 10px; border-radius: 20px; font-size: 0.8em; font-weight: bold; margin-bottom: 15px;
        }
        ...
        .btn-agendar {
            display: block; width: 100%; padding: 12px 0; background: #4caf50; color: white;
            text-decoration: none; font-weight: bold; border-radius: 6px; transition: 0.2s; box-sizing: border-box;
        }
...
<body>
    ...
    <div class="boas-vindas">
        ...
        <p>Abaixo estão os residentes que adorariam receber uma visita ou um pouco de carinho. Escolha alguém para doar o seu tempo.</p>
    </div>
